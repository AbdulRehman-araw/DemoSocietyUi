...
const CancelModal = ({ visible, close, type, text, button, warning, loading, cancel }) => {
    return (
                ...
                <View style={styles.centerCon}>
                    ...
                    {button &&
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <DenayBtn
                                customStyle={{  marginRight: width * 0.02,  paddingHorizontal: width * 0.043, paddingVertical: width * 0.035, marginRight: width * 0.05 }}
                                title={'No'}
                                loader={loading}
                                onPress={cancel}
                            />
                            ...
                            <PrimaryButton
                                customStyle={{ paddingVertical: width * 0.035, paddingHorizontal:width * 0.043, marginLeft: width * 0.02 }}
                                title={'Yes'}
                                loader={loading}
                                onPress={warning}
                            />

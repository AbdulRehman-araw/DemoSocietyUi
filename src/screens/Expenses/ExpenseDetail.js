import { View, SafeAreaView, StatusBar, ScrollView, Dimensions, Platform, BackHandler, Text, ActivityIndicator, TouchableOpacity, Image } from 'react-native'
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{
          ...
          <View style={{ paddingHorizontal: width * 0.02 }}>
            ...
            <ScrollView horizontal={true} style={{ flex: 1 }}>
              ...
              <View style={{ paddingHorizontal: width * 0.01, flex: 1, marginTop: 10, paddingBottom: width * 0.1, width: 1000 }}>
                ...
                <DataTable style={{ borderColor: colors.gray, borderWidth: 1, borderRadius: 9 }}>
                  <DataTable.Row style={{ backgroundColor: colors.primary, borderTopLeftRadius: 9, borderTopRightRadius: 9 }}>
                    ...
                    <DataTable.Title numeric style={[styles.tableCell, styles.border]}>
                      <CustomText fontWeight={fontsFamily.semiBold} style={{ color: colors.white }}>Title</CustomText>
                    </DataTable.Title>
                    <DataTable.Title numeric style={[styles.tableCellDec, styles.border]}>
                      <CustomText fontWeight={fontsFamily.semiBold} style={{ color: colors.white }}>Description</CustomText>
                    </DataTable.Title>
                    <DataTable.Title numeric style={[styles.tableCell, styles.border]}>
                      <CustomText fontWeight={fontsFamily.semiBold} style={{ color: colors.white }}>Quantity</CustomText>
                    </DataTable.Title>
                    <DataTable.Title numeric style={[styles.tableCell, styles.border]}>
                      <CustomText fontWeight={fontsFamily.semiBold} style={{ color: colors.white }}>Date</CustomText>
                    </DataTable.Title>
                    <DataTable.Title numeric style={[styles.tableCell, styles.border]}>
                  ...
                  <DataTable.Row>
                    <DataTable.Cell style={{flex:0.05}}>
                      <Text style={{ fontFamily: fontsFamily.medium, color: colors.primary }}>{1}</Text>
                    </DataTable.Cell>
                    <DataTable.Cell style={[styles.tableCell, styles.border]}>
                      <Text style={{ fontFamily: fontsFamily.medium, color: colors.primary }}>{updateData?.expenseName}</Text>
                    </DataTable.Cell>


                    <DataTable.Title numberOfLines={3} style={[styles.tableCellDec, styles.border]}>
                      <Text style={{ fontFamily: fontsFamily.medium, color: colors.primary }}> {updateData?.description}</Text>
                    </DataTable.Title>
                    <DataTable.Cell style={[styles.tableCell, styles.border]}>
                      <Text style={{ fontFamily: fontsFamily.medium, color: colors.primary }}>{updateData?.quantity}</Text>
                    </DataTable.Cell>
                    <DataTable.Cell style={[styles.tableCell, styles.border]}>
                      <Text style={{ fontFamily: fontsFamily.medium, color: colors.primary }}>{moment(updateData?.date).format('l')}</Text>
                    </DataTable.Cell>
                    <DataTable.Cell style={[styles.tableCell, styles.border]}>
                      <Text style={{ fontFamily: fontsFamily.medium, color: colors.primary }}>{updateData?.amount.toLocaleString("en-US")}</Text>
                    </DataTable.Cell>
            ...
            <View style={{ marginVertical: width * 0.07, flexDirection: 'row', gap: 8, justifyContent: 'center' }}>

...
const BankPaymentVoucher = ({navigation}) => {
  ...
  const getBankPaymentVouchers = async () => {
    setLoader(true);
    try {
      const {data} = await apiCall.getBankPaymentVouchers();
      setBankPaymentVouchers(data);
    } catch (error) {

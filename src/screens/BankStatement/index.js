...
const BankStatement = ({ navigation }) => {
  ...
  const getBankStatements = async formData => {
 ...
 console.log("🚀 ~ getBankStatements ~ formData:", data)
      ...
      console.log(
        'file: index.js:49 => getBankStatements => error:',
        error,
  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <View style={{ paddingHorizontal: width * 0.032, flex: 1 }}>
        <Header onBack={goBack} title={'Bank Statements'} />
          ...
          <View style={{ paddingHorizontal: width * 0.02 }}>
            ...
            <View style={{ marginVertical: width * 0.01 }}>
              <LinearGradientPrimaryButton
                ...
                onPress={handleSubmit(getBankStatements)}
              />
            </View>

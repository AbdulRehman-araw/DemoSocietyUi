...
const EditEmergencyContact = ({ navigation, route }) => {
    ...
    const setDefaultData = () => {
        try {
            setValue('contactType', item?.contactType)
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{
                    ...
                    <View style={{ paddingHorizontal: width * 0.038 }}>
                        ...
                        <FilledTextField
                            ...
                            onSubmitEditing={handleSubmit(editContact)}
                        />
                        <FilledTextField
                            name={'contactNo'}
                        ...
                        <View style={{ marginTop: width * 0.03, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flexWrap: "wrap" }}>
                            ...
                            <View style={{ width: '47%' }}>
                                <PrimaryButton
                                    ...
                                    title={'Create'}
                                    loader={loader}
                                    onPress={handleSubmit(editContact)}
                                />
                            </View>

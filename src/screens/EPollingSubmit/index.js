...
const FeedBackPolling = ({navigation}) => {
...
{text.feedbackpolling}
  </CustomText>                               
<View style={{marginTop:5}}>
  <Text style={styles.text3}>Thankyou for your Feedback</Text> 
  <Text style={styles.text2}>Do patient while we look your problem</Text>
  <Text style={styles.text3}>Thankyou!</Text>
   </View>
</View>
...
export default FeedBackPolling;

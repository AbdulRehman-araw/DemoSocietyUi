...
const CustomerStatements = ({ navigation }) => {
  ...
  const getCustomerStatements = async formData => {
    ...
    try {
      ...
      console.log("🚀 ~ getCustomerStatements ~ formData:", soldApartment,
        fromDate,
        toDate,)
      const { data } = await apiCall.getCustomerStatements(
        accountId,
        fromDate,
        toDate,
      );
      ...
      console.log(
        'file: index.js:49 => getCustomerStatements => error:',
        error,
      );
    } finally {
      setLoader(false);
  ...
  console.log("customerStatements", customerStatements)
    ...
    <>
      <SafeAreaView style={styles.root}>
        ...
        <View style={{ paddingHorizontal: width * 0.032, flex: 1 }}>
          <Header onBack={goBack} title={'Customer Statements'} />
          ...
          <ScrollView
            ...
            <DateTimePicker
              ...
              mode={'date'}
            />
            {/* {(customerStatements !== undefined && customerStatements.length !== 0 &&loader) && 
            <StatementPdf

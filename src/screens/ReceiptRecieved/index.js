...
const ReceiptRecieved = ({ navigation }) => {
      ...
      <View style={{ paddingHorizontal: width * 0.032, flex: 1 }}>
        ...
        <View>
          ...
          <View style={{ marginTop: 5 }}>
            ...
            <Text style={styles.text2}>Your Receipt has been sent to the admin</Text>
...
export default ReceiptRecieved;

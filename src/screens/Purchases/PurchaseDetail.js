...
const PurchaseDetail = ({navigation, route}) => {
  ...
  const getVendors = async () => {
    try {
      ...
      const vendorName = data.find(
        e => e.vendorID === updateData.vendorID,
      )?.name;
  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <View style={{paddingHorizontal: width * 0.032, flex: 1}}>
        <Header onBack={() => goBack()} title={updateData?.description} />

        <View style={[styles.viewname, styles.top]}>
          <View style={{}}>
            <CustomText
              fontWeight={fontsFamily.bold}
              style={{...styles.name, fontSize: 20, marginBottom: 20}}>
              Purchase Detail
            </CustomText>

            <CustomText
              fontWeight={fontsFamily.medium}
              style={{...styles.name, color: colors.darkGray}}>
              Purchase Account
            </CustomText>

            <CustomText fontWeight={fontsFamily.bold} style={styles.username}>
        ...
        <View style={styles.viewname}>
          <View style={{}}>
            ...
            <CustomText fontWeight={fontsFamily.medium} style={styles.username}>
        ...
        <View style={styles.viewname}>
          <View style={{}}>
            ...
            {/* <CustomText fontWeight={fontsFamily.semiBold} style={{...styles.name, color:colors.darkGray}}>
              Date
            </CustomText>
              ...
              <DataTable
                ...
                <DataTable.Row
                  ...
                  {/* <DataTable.Cell style={{flex: 0.1}}>
                    <CustomText
                      fontWeight={fontsFamily.semiBold}
                      style={{color: colors.darkGray, fontSize:10}}>
                      S.No
                    </CustomText>
                  </DataTable.Cell> */}
                  <DataTable.Title
                    numeric
                    style={[styles.tableCellName, styles.border]}>
                    <CustomText
                      fontWeight={fontsFamily.semiBold}
                      style={{color: colors.darkGray, fontSize: 10}}>
                      Product Name

...
const TenantRegistrationCard = ({
  ...
  const handleStatus = async status => {
    ...
    if (status === true) {
      try {
        let result = await apiCall.tenantApproveRegistrationStatus(
            ...
            {loader ? (
              ...
              <Fragment>
                <View style={styles.viewall}>
                  ...
                  <DocumentList
                    data={completeData?.agreement}
                    name={'Agreement'}
                  />

                  <DocumentList
                    data={completeData?.undertakingLetter}
                    name={'Undertaking Letter'}
                  />

                  <DocumentList data={completeData?.noc} name={'NOC'} />

                  <DocumentList
                    data={completeData?.policeVerification}
...
export default TenantRegistrationCard;
